           ...
           <li class="nav-item dropdown">
               ...
               <div class="dropdown-menu" aria-labelledby="ddlAlumnos">
				...
				<li class="nav-item dropdown">
                   ...
                   <a class="dropdown-item" href="ModificarCurso.jsp">Modificacion</a>
                   <div class="dropdown-divider"></div>
                   <a class="dropdown-item" href="ListarCursos.jsp">Listado</a>
                   <div class="dropdown-divider"></div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="ServletLogin?Param=1">Salir</a>
        </div>
      </div>
    </div>
  </div>
