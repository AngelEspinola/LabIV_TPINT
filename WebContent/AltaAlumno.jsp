        ...
        <div class="col-10 card formulario">
            ...
            <div class=" card-body">
                <form class="needs-validation" name="altaAlumno" action="ServletAlumno?Alta=alta" method="get">
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="input-group">
                                ...
                                pattern="[1-2][0-9]{3}/[0-1][0-9]/[0-3][0-9]" value="<%=a.getNacimiento()%>" required>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="input-group">
                                ...
                                <select class="custom-select" id="ddlProvincia" name="ddlProvincia" onChange="javascript:document.altaAlumno.submit();" required>
                    ...
                    <button class="btn btn-success" type="submit" name="btnAltaAlumno" value="aceptar">Agregar</button>
                </form>
            </div>
